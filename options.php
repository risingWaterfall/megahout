 ...
 *
 * If you are making your theme translatable, you should replace 'megahout'
...
function optionsframework_options() {
	...
	$options[] = array(
		'name' => __('Header Meta', 'megahout'),
		'type' => 'heading');

// Standard Meta
	$options[] = array(
		'name' => __('Head ID', 'megahout'),
		'desc' => __("", 'megahout'),
		'id' => 'meta_headid',
		'std' => 'megahout',
		'type' => 'text');
	$options[] = array(
		'name' => __('Google Webmasters', 'megahout'),
		'desc' => __("Speaking of Google, don't forget to set your site up: <a href='http://google.com/webmasters' target='_blank'>http://google.com/webmasters</a>", 'megahout'),
		'id' => 'meta_google',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('Author Name', 'megahout'),
		'desc' => __('Populates meta author tag.', 'megahout'),
		'id' => 'meta_author',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('Mobile Viewport', 'megahout'),
		'desc' => __('Uncomment to use; use thoughtfully!', 'megahout'),
		'id' => 'meta_viewport',
...
// Icons
	$options[] = array(
		'name' => __('Site Favicon', 'megahout'),
		'desc' => __('', 'megahout'),
		'id' => 'head_favicon',
		'type' => 'upload');
	$options[] = array(
		'name' => __('Apple Touch Icon', 'megahout'),
		'desc' => __('', 'megahout'),
...
// App: Windows 8
	$options[] = array(
		'name' => __('App: Windows 8', 'megahout'),
		'desc' => __('Application Name', 'megahout'),
		'id' => 'meta_app_win_name',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'megahout'),
		'desc' => __('Tile Color', 'megahout'),
		'id' => 'meta_app_win_color',
		'std' => '',
		'type' => 'color');
	$options[] = array(
		'name' => __('', 'megahout'),
		'desc' => __('Tile Image', 'megahout'),
...
// App: Twitter
	$options[] = array(
		'name' => __('App: Twitter Card', 'megahout'),
		'desc' => __('twitter:card (summary, photo, gallery, product, app, player)', 'megahout'),
		'id' => 'meta_app_twt_card',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'megahout'),
		'desc' => __('twitter:site (@username of website)', 'megahout'),
		'id' => 'meta_app_twt_site',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'megahout'),
		'desc' => __("twitter:title (the user's Twitter ID)", 'megahout'),
		'id' => 'meta_app_twt_title',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'megahout'),
		'desc' => __('twitter:description (maximum 200 characters)', 'megahout'),
		'id' => 'meta_app_twt_description',
		'std' => '',
		'type' => 'textarea');
	$options[] = array(
		'name' => __('', 'megahout'),
		'desc' => __('twitter:url (url for the content)', 'megahout'),
		'id' => 'meta_app_twt_url',
		'std' => '',
		'type' => 'text');
...
// App: Facebook
	$options[] = array(
		'name' => __('App: Facebook', 'megahout'),
		'desc' => __('og:title', 'megahout'),
		'id' => 'meta_app_fb_title',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'megahout'),
		'desc' => __('og:description', 'megahout'),
		'id' => 'meta_app_fb_description',
		'std' => '',
		'type' => 'textarea');
	$options[] = array(
		'name' => __('', 'megahout'),
		'desc' => __('og:url', 'megahout'),
		'id' => 'meta_app_fb_url',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'megahout'),
		'desc' => __('og:image', 'megahout'),
